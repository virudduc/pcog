...
<div class="navbar navbar-inverse">
		  <div class="navbar-inner">
		   <div class="container-fluid">
			  ...
			  <a class="brand" href="dashboard.php"><small><i class="icon-leaf"></i> <?php echo $application_title;?> </small> </a>
			  <ul class="nav ace-nav pull-right">
			  <?php if($_SESSION['userinfo']['user_id']=='1') {?>
					<a class="brand" href="dashboard.php"><small>PCog Admin Panel</small> </a>
					<!--li class="grey">
					...
					<?php } ?>
						...
						<a class="user-menu dropdown-toggle" href="../index.php" target="_blank" >
							
							<span id="user_info">
								<storng Style="display:inline-block; margin-top:7px;">View Site</storng>
							</span>
						</a>
					</li-->
					...
					<li class="light-blue user-profile">
						...
						<ul id="user_menu" class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							...
							<li><a href="change_profile.php"><i class="icon-user"></i> Profile</a></li>
							<li class="divider"></li>
