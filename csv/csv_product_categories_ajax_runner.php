...
$config['hooks_file']  =  "csv/hooks/product_categories_csv_hooks.php";
//csv/hooks/product_categories_csv_hooks.php
$config['table_name'] = "cms_product_categories";
$config['lines_percall'] = "200";
$config['ajax_page'] = "../csv_product_categories_ajax.php";
$config['ajax_page_runner'] = "csv_product_categories_ajax_runner.php";
