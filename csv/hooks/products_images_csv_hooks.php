<?php
	...
	*/
	class csv_hook
	{
		...
		function process_product_id ( $field_value ) {
			$field_query = "select * from cms_products where product_name ='" . trim( $field_value ) ."'";
			...
			{
				// Insert if not exist
				$field_insert_query = "insert into cms_products (product_name) values( '$field_value' )";
