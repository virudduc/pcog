...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Retailers_profile - <?php echo SITENAME; ?></title>
			...
			<div id="main-content" class="clearfix">
					<div id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Retailers_profile</li>
						</ul><!--.breadcrumb-->
						<div id="nav-search">
 ...
 <span class="hidden-phone"> Columns </span> <b class="caret"></b> </div>
        <ul class="dropdown-menu">
		  ...
		  <label class="checkbox">
				...
				<input type="checkbox" class="columncontrol" checked="checked" value="store_logo"><span class="lbl"> Store logo </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_name"><span class="lbl"> Store Name </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_address"><span class="lbl"> Store Address </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_phone"><span class="lbl"> Store Phone </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_description"><span class="lbl"> Store description </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_website"><span class="lbl"> Store Website </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_zip"><span class="lbl"> Store Zip Code </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="store_email"><span class="lbl"> Store Email ID </span></label>  <label class="checkbox">
				...
				<input type="checkbox" class="columncontrol" checked="checked" value="latitude"><span class="lbl"> Latitude </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="zoom_level"><span class="lbl"> Zoom Level </span></label>
          </li>
        </ul>
      </span>
	  <button data-target="#myModal" data-toggle="modal" id="addnewrec"  class="pull-right btn btn-small btn-primary">Add</button>
							<h1>Retailers_profile<small><i class="icon-double-angle-right"></i> Retailers_profile</small></h1>
						</div><!--/page-header-->
						<div class="row-fluid" >
<!-- PAGE CONTENT BEGINS HERE -->
<div style="100%" id="section_retailers_profile">
<div class="row-fluid" >
	...
	<!--  ACTION BOX ENDS HERE -->
		...
		<div class="control-group">
				...
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--id" class="pag_filter input-medium search-query " placeholder="Search Id">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > User Name</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--user_id" class="pag_filter input-medium search-query " placeholder="Search User Name">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store logo</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_logo" class="pag_filter input-medium search-query " placeholder="Search Store logo">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store Name</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_name" class="pag_filter input-medium search-query " placeholder="Search Store Name">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store Address</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_address" class="pag_filter input-medium search-query " placeholder="Search Store Address">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store Phone</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_phone" class="pag_filter input-medium search-query " placeholder="Search Store Phone">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store description</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_description" class="pag_filter input-medium search-query " placeholder="Search Store description">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store Website</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_website" class="pag_filter input-medium search-query " placeholder="Search Store Website">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store Zip Code</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_zip" class="pag_filter input-medium search-query " placeholder="Search Store Zip Code">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Store Email ID</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--store_email" class="pag_filter input-medium search-query " placeholder="Search Store Email ID">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Longitude</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--longitude" class="pag_filter input-medium search-query " placeholder="Search Longitude">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Latitude</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--latitude" class="pag_filter input-medium search-query " placeholder="Search Latitude">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Zoom Level</label>
				<div class="controls ">
					<input type="text"  id="pag_search_retailers_profile--zoom_level" class="pag_filter input-medium search-query " placeholder="Search Zoom Level">
				</div>
		</div>
								<div style="clear:both;"></div>
                                <div class="span6">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th data-bind="click:sortby.bind($data, 'retailers_profile.user_id')" style="cursor: pointer; display: none;" class="col_user_id"><i class="sort_icon" id="sorticon_user_id"></i>User Name</th> 
							<th data-bind="click:sortby.bind($data, 'retailers_profile.store_logo')" style="cursor: pointer; display: none;" class="col_store_logo"><i class="sort_icon" id="sorticon_store_logo"></i>Store logo</th> 
							<th data-bind="click:sortby.bind($data, 'retailers_profile.store_name')" style="cursor: pointer; display: none;" class="col_store_name"><i class="sort_icon" id="sorticon_store_name"></i>Store Name</th> 
							<th data-bind="click:sortby.bind($data, 'retailers_profile.store_address')" style="cursor: pointer; display: none;" class="col_store_address"><i class="sort_icon" id="sorticon_store_address"></i>Store Address</th> 
							<th>Action</th>				
						</tr>
					</thead>
					<tbody data-bind="foreach:retailers_profile">
						<tr>
							<td class="center sorting_1">
								<label><input type="checkbox" class="title idcheck" name="id[]"  data-bind="attr:{value: id}" id="id[]" value="" /><span class="lbl"></span></label>
										...
										<td data-bind="text: store_name" class="col_store_name" style="display: none;"></td> 
										<td data-bind="text: store_address" class="col_store_address" style="display: none;"></td> 
							<td>
...
<div class="control-group">
            <label class="control-label" > Store Name</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_store_name" name="store_name" placeholder="Store Name" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Store Address</label>
            <div class="controls">
       <textarea class="span4" id="pag_search_store_address" name="store_address" placeholder="Store Address" ></textarea>
	   </div>
          </div>
<div class="control-group">
            <label class="control-label" > Store Phone</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_store_phone" name="store_phone" placeholder="Store Phone" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Store description</label>
            <div class="controls">
       <textarea class="span4" id="pag_search_store_description" name="store_description" placeholder="Store description" ></textarea>
	   </div>
          </div>
<div class="control-group">
            <label class="control-label" > Store Website</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_store_website" name="store_website" placeholder="Store Website" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Store Zip Code</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_store_zip" name="store_zip" placeholder="Store Zip Code" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Store Email ID</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_store_email" name="store_email" placeholder="Store Email ID" required>
			  </div>
          </div>
        </form>
      </div>
...
// CHECKLIST MODEL 
	function AppViewModelretailers_profile(retailers_profile) {
	var self = this;
		self.retailers_profile = retailers_profile;
	...
	// ADD NEW ITEM
   self.addretailers_profile = function() {
		var fname="";
        self.retailers_profile.push({ id: ko.observable(),checklist_name: ko.observable() });
		self.saveretailers_profile();
    };
	...
	self.deleteselecteddata = function(){
			$.ajax({
			type: "POST",
			url: "services/retailers_profile_delete.php",
	...
	self.savenew = function(){
		$.ajax({
		  type: "POST",
		   url: "services/retailers_profile_new.php",
	...
	// Looping up all the filters start here. 
		...
		$.ajax({
					type: "POST",
					url: "services/retailers_profile_fetch.php",
					data : pag_filters,
					dataType: 'json'
					}).done(
					function( data ) 
					{
						...
						ko.mapping.fromJS(viewModel, self.retailers_profile);
	...
	// SAVE THE MODEL
	self.saveretailers_profile = function() {
		$('#message').show();
		//alert(ko.toJSON(self.retailers_profile));
		mydataa = ko.toJSON(self.retailers_profile);
		$.ajax({
		  type: "POST",
		  url: "services/retailers_profile_update.php",
		  data: { mydata: mydataa }
			}).done(function( msg ) {
	...
	self.removeItem = function() {
        self.retailers_profile.remove(this);
...
<script language="javascript">
$(document).ready(function(){
	var retailers_profile = new AppViewModelretailers_profile(ko.mapping.fromJS([]));
	ko.applyBindings((retailers_profile),$("#section_retailers_profile")[0]);
	retailers_profile.loaddata();
	retailers_profile.update_pagination();
});
</script>
<script type="text/javascript">
$(document).ready(function() {
