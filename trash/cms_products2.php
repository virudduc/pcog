...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Cms_products - <?php echo SITENAME; ?></title>
 ...
 <span class="hidden-phone"> Columns </span> <b class="caret"></b> </div>
        <ul class="dropdown-menu">
		  ...
		  <label class="checkbox">
				...
				<input type="checkbox" class="columncontrol" checked="checked" value="user_id"><span class="lbl"> User Name </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="product_name"><span class="lbl"> Product Name </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="product_short_desc"><span class="lbl"> Product short desc </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="description"><span class="lbl"> Description </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="product_price"><span class="lbl"> Price($) </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="discount"><span class="lbl"> Discount(%) </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="product_title_image"><span class="lbl"> Product title image </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="product_category_id"><span class="lbl"> Category </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="status"><span class="lbl"> Status </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="created"><span class="lbl"> Created on </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="modified"><span class="lbl"> Modified on </span></label>  <label class="checkbox">
				<input type="checkbox" class="columncontrol" checked="checked" value="brands_id"><span class="lbl"> Brand Name </span></label>
          </li>
        </ul>
      </span>
	  <button data-target="#myModal" data-toggle="modal" id="addnewrec"  class="pull-right btn btn-small btn-primary">Add</button>
							<h1>Products<small><i class="icon-double-angle-right"></i> Management</small></h1>
						</div><!--/page-header-->
						<div class="row-fluid" >
<!-- PAGE CONTENT BEGINS HERE -->
<div style="100%" id="section_cms_products">
<div class="row-fluid" >
	...
	<!--  ACTION BOX ENDS HERE -->
		...
		<div class="control-group">
				...
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--id" class="pag_filter input-medium search-query " placeholder="Search Id">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > User Name</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--user_id" class="pag_filter input-medium search-query " placeholder="Search User Name">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Product Name</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--product_name" class="pag_filter input-medium search-query " placeholder="Search Product Name">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Product short desc</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--product_short_desc" class="pag_filter input-medium search-query " placeholder="Search Product short desc">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Description</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--description" class="pag_filter input-medium search-query " placeholder="Search Description">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Price($)</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--product_price" class="pag_filter input-medium search-query " placeholder="Search Price($)">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Discount(%)</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--discount" class="pag_filter input-medium search-query " placeholder="Search Discount(%)">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Product title image</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--product_title_image" class="pag_filter input-medium search-query " placeholder="Search Product title image">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Category</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--product_category_id" class="pag_filter input-medium search-query " placeholder="Search Category">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Status</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--status" class="pag_filter input-medium search-query " placeholder="Search Status">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Created on</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--created" class="pag_filter input-medium search-query " placeholder="Search Created on">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Modified on</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--modified" class="pag_filter input-medium search-query " placeholder="Search Modified on">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Brand Name</label>
				<div class="controls ">
					<input type="text"  id="pag_search_cms_products--brands_id" class="pag_filter input-medium search-query " placeholder="Search Brand Name">
				</div>
		</div>
								<div style="clear:both;"></div>
                                <div class="span6">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th data-bind="click:sortby.bind($data, 'cms_products.user_id')" style="cursor: pointer; display: none;" class="col_user_id"><i class="sort_icon" id="sorticon_user_id"></i>User Name</th> 
							<th data-bind="click:sortby.bind($data, 'cms_products.product_name')" style="cursor: pointer; display: none;" class="col_product_name"><i class="sort_icon" id="sorticon_product_name"></i>Product Name</th> 
							<th data-bind="click:sortby.bind($data, 'cms_products.product_price')" style="cursor: pointer; display: none;" class="col_product_price"><i class="sort_icon" id="sorticon_product_price"></i>Price($)</th> 
							<th data-bind="click:sortby.bind($data, 'cms_products.product_title_image')" style="cursor: pointer; display: none;" class="col_product_title_image"><i class="sort_icon" id="sorticon_product_title_image"></i>Product title image</th> 
							<th data-bind="click:sortby.bind($data, 'cms_products.product_category_id')" style="cursor: pointer; display: none;" class="col_product_category_id"><i class="sort_icon" id="sorticon_product_category_id"></i>Category</th> 
							<th data-bind="click:sortby.bind($data, 'cms_products.status')" style="cursor: pointer; display: none;" class="col_status"><i class="sort_icon" id="sorticon_status"></i>Status</th> 
							<th data-bind="click:sortby.bind($data, 'cms_products.brands_id')" style="cursor: pointer; display: none;" class="col_brands_id"><i class="sort_icon" id="sorticon_brands_id"></i>Brand Name</th> 
							<th>Action</th>				
						</tr>
					</thead>
					<tbody data-bind="foreach:cms_products">
						<tr>
							<td class="center sorting_1">
								<label><input type="checkbox" class="title idcheck" name="id[]"  data-bind="attr:{value: id}" id="id[]" value="" /><span class="lbl"></span></label>
							</td>
										<td data-bind="text: user_id" class="col_user_id" style="display: none;"></td> 
										<td data-bind="text: product_name" class="col_product_name" style="display: none;"></td> 
										<td data-bind="text: product_price" class="col_product_price" style="display: none;"></td> 
										<td data-bind="text: product_category_id" class="col_product_category_id" style="display: none;"></td> 
										<td data-bind="text: status" class="col_status" style="display: none;"></td> 
										<td data-bind="text: brands_id" class="col_brands_id" style="display: none;"></td> 
							<td>
...
<div class="control-group">
            <label class="control-label" >User Name</label>
            <div class="controls">
          <select  id="pag_search_user_id" name="user_id" placeholder="User Name" >
			<?php
				$vt_users_query ="select * from vt_users";
				$vt_users_rs = mysql_query($vt_users_query) or die(mysql_error()."</br> Failed Query".$project_query );
				//Loop Placed here. 
				while($vt_users_row = mysql_fetch_array($vt_users_rs))
				{
				?> 
				<option value="<?php echo $vt_users_row['id'] ;?>"><?php echo $vt_users_row['username'] ;?></option>
				<?php 
				}
			?>
         </select>
...
<div class="control-group">
            <label class="control-label" > Product Name</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_product_name" name="product_name" placeholder="Product Name" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Product short desc</label>
            <div class="controls">
       <textarea class="span4" id="pag_search_product_short_desc" name="product_short_desc" placeholder="Product short desc" ></textarea>
	   </div>
          </div>
	<div class="control-group">
            <label class="control-label" > Description</label>
            <div class="controls">
       <textarea  id="editor_description" name="description" placeholder="Description" ></textarea>
	   </div>
          </div>
<div class="control-group">
            <label class="control-label" > Price($)</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_product_price" name="product_price" placeholder="Price($)" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Discount(%)</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_discount" name="discount" placeholder="Discount(%)" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" >Status</label>
            <div class="controls">
          <select  id="pag_search_status" name="status" placeholder="Status" >
			<?php
				$product_status_query ="select * from product_status";
				$product_status_rs = mysql_query($product_status_query) or die(mysql_error()."</br> Failed Query".$project_query );
				//Loop Placed here. 
				while($product_status_row = mysql_fetch_array($product_status_rs))
				{
				?> 
				<option value="<?php echo $product_status_row['status'] ;?>"><?php echo $product_status_row['status'] ;?></option>
				<?php 
				}
			?>
         </select>
              ...
              <input type="hidden" value="date('Y-m-d H:i:s')"  id="pag_search_created" name="created" placeholder="Created on" required>
              <input type="hidden" value="date('Y-m-d H:i:s')"  id="pag_search_modified" name="modified" placeholder="Modified on" required>
<div class="control-group">
            <label class="control-label" >Brand Name</label>
            <div class="controls">
          <select  id="pag_search_brands_id" name="brands_id" placeholder="Brand Name" >
			<?php
				$product_brands_query ="select * from product_brands";
				$product_brands_rs = mysql_query($product_brands_query) or die(mysql_error()."</br> Failed Query".$project_query );
				//Loop Placed here. 
				while($product_brands_row = mysql_fetch_array($product_brands_rs))
				{
				?> 
				<option value="<?php echo $product_brands_row['id'] ;?>"><?php echo $product_brands_row['brand_name'] ;?></option>
				<?php 
				}
			?>
         </select>
...
<!-- PAGE CONTENT ENDS HERE -->
		...
		$(document).ready(function(){
						myeditor_description = CKEDITOR.replace( 'description' );
		});
		</script>
		<!-- ace scripts -->
...
// CHECKLIST MODEL 
	function AppViewModelcms_products(cms_products) {
	var self = this;
		self.cms_products = cms_products;
	...
	// ADD NEW ITEM
   self.addcms_products = function() {
		var fname="";
        self.cms_products.push({ id: ko.observable(),checklist_name: ko.observable() });
		self.savecms_products();
    };
	...
	self.deleteselecteddata = function(){
			$.ajax({
			type: "POST",
			url: "services/cms_products_delete.php",
	...
	self.savenew = function(){
						$('#editor_description').val(myeditor_description.getData());
		$.ajax({
		  type: "POST",
		   url: "services/cms_products_new.php",
	...
	// Looping up all the filters start here. 
		...
		$.ajax({
					type: "POST",
					url: "services/cms_products_fetch.php",
					data : pag_filters,
					dataType: 'json'
					}).done(
					function( data ) 
					{
						...
						ko.mapping.fromJS(viewModel, self.cms_products);
	...
	// SAVE THE MODEL
	self.savecms_products = function() {
		$('#message').show();
		//alert(ko.toJSON(self.cms_products));
		mydataa = ko.toJSON(self.cms_products);
		$.ajax({
		  type: "POST",
		  url: "services/cms_products_update.php",
		  data: { mydata: mydataa }
			}).done(function( msg ) {
	...
	self.editItem = function() {
	   ...
	   var browserName=navigator.appName; 
		...
		{
					myeditor_description.setData($('#editor_description').html());
		}
		else
		{
					myeditor_description.setData($('#editor_description').text());
		}
	   $('#myModal').modal('show');
...
<script language="javascript">
$(document).ready(function(){
	var cms_products = new AppViewModelcms_products(ko.mapping.fromJS([]));
	ko.applyBindings((cms_products),$("#section_cms_products")[0]);
	cms_products.loaddata();
	cms_products.update_pagination();
});
</script>
<script type="text/javascript">
$(document).ready(function() {
