...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Documentation_log - <?php echo SITENAME; ?></title>
			...
			<div id="main-content" class="clearfix">
					<div id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Doumentation</li>
						</ul><!--.breadcrumb-->
						<div id="nav-search">
 ...
 <span class="hidden-phone"> Columns </span> <b class="caret"></b> </div>
        <ul class="dropdown-menu">
		  ...
		  <label class="checkbox">
				...
				<input type="checkbox" class="columncontrol" checked="checked" value="page_content"><span class="lbl"> Documentation </span></label>  <label class="checkbox">
	  ...
	  <button data-target="#myModal" data-toggle="modal" id="addnewrec"  class="pull-right btn btn-small btn-primary">Add</button>
							<h1>Doumentation<small><i class="icon-double-angle-right"></i> Management</small></h1>
						</div><!--/page-header-->
						<div class="row-fluid" >
<!-- PAGE CONTENT BEGINS HERE -->
<div style="100%" id="section_documentation_log">
<div class="row-fluid" >
	...
	<!--  ACTION BOX ENDS HERE -->
		...
		<div class="control-group">
				...
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--id" class="pag_filter input-medium search-query " placeholder="Search Id">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Page title</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--page_title" class="pag_filter input-medium search-query " placeholder="Search Page title">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Page short description</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--page_short_description" class="pag_filter input-medium search-query " placeholder="Search Page short description">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Documentation</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--page_content" class="pag_filter input-medium search-query " placeholder="Search Documentation">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Page status</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--page_status" class="pag_filter input-medium search-query " placeholder="Search Page status">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Meta keywords</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--meta_keywords" class="pag_filter input-medium search-query " placeholder="Search Meta keywords">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Meta description</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--meta_description" class="pag_filter input-medium search-query " placeholder="Search Meta description">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Create date</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--create_date" class="pag_filter input-medium search-query " placeholder="Search Create date">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Modify date</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--modify_date" class="pag_filter input-medium search-query " placeholder="Search Modify date">
				</div>
		</div>
		<div class="control-group">
				<label class="control-label " > Author</label>
				<div class="controls ">
					<input type="text"  id="pag_search_documentation_log--author" class="pag_filter input-medium search-query " placeholder="Search Author">
				</div>
		</div>
								<div style="clear:both;"></div>
                                <div class="span6">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th data-bind="click:sortby.bind($data, 'documentation_log.id')" style="cursor: pointer; display: none;" class="col_id"><i class="sort_icon" id="sorticon_id"></i>Id</th> 
							<th data-bind="click:sortby.bind($data, 'documentation_log.page_title')" style="cursor: pointer; display: none;" class="col_page_title"><i class="sort_icon" id="sorticon_page_title"></i>Page title</th> 
							<th data-bind="click:sortby.bind($data, 'documentation_log.page_content')" style="cursor: pointer; display: none;" class="col_page_content"><i class="sort_icon" id="sorticon_page_content"></i>Documentation</th> 
							<th data-bind="click:sortby.bind($data, 'documentation_log.modify_date')" style="cursor: pointer; display: none;" class="col_modify_date"><i class="sort_icon" id="sorticon_modify_date"></i>Modify date</th> 
							<th>Action</th>				
						</tr>
					</thead>
					<tbody data-bind="foreach:documentation_log">
						<tr>
							<td class="center sorting_1">
								<label><input type="checkbox" class="title idcheck" name="id[]"  data-bind="attr:{value: id}" id="id[]" value="" /><span class="lbl"></span></label>
										...
										<td data-bind="html: page_content" class="col_page_content" style="display: none;"></td> 
...
<div class="control-group">
	...
	<div class="control-group">
            <label class="control-label" > Documentation</label>
            <div class="controls">
       <textarea  id="editor_page_content" name="page_content" placeholder="Documentation" ></textarea>
	   </div>
          </div>
<div class="control-group">
            <label class="control-label" > Page status</label>
            <div class="controls">
              <input  class="span4"  value="" type="text"  id="pag_search_page_status" name="page_status" placeholder="Page status" required>
			  </div>
          </div>
<div class="control-group">
            <label class="control-label" > Meta keywords</label>
...
// CHECKLIST MODEL 
	function AppViewModeldocumentation_log(documentation_log) {
	var self = this;
		self.documentation_log = documentation_log;
	...
	// ADD NEW ITEM
   self.adddocumentation_log = function() {
		var fname="";
        self.documentation_log.push({ id: ko.observable(),checklist_name: ko.observable() });
		self.savedocumentation_log();
    };
	...
	self.deleteselecteddata = function(){
			$.ajax({
			type: "POST",
			url: "services/documentation_log_delete.php",
	...
	self.savenew = function(){
		...
		$.ajax({
		  type: "POST",
		   url: "services/documentation_log_new.php",
	...
	// Looping up all the filters start here. 
		...
		$.ajax({
					type: "POST",
					url: "services/documentation_log_fetch.php",
					data : pag_filters,
					dataType: 'json'
					}).done(
					function( data ) 
					{
						...
						ko.mapping.fromJS(viewModel, self.documentation_log);
	...
	// SAVE THE MODEL
	self.savedocumentation_log = function() {
		$('#message').show();
		//alert(ko.toJSON(self.documentation_log));
		mydataa = ko.toJSON(self.documentation_log);
		$.ajax({
		  type: "POST",
		  url: "services/documentation_log_update.php",
		  data: { mydata: mydataa }
			}).done(function( msg ) {
	...
	self.removeItem = function() {
        self.documentation_log.remove(this);
...
<script language="javascript">
$(document).ready(function(){
	var documentation_log = new AppViewModeldocumentation_log(ko.mapping.fromJS([]));
	ko.applyBindings((documentation_log),$("#section_documentation_log")[0]);
	documentation_log.loaddata();
	documentation_log.update_pagination();
});
</script>
<script type="text/javascript">
$(document).ready(function() {
